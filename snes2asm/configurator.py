...
class Configurator:
	def __init__(self, file_path):
		...
		self.decoders_enabled = {'data': Decoder, 'text': TextDecoder, 'gfx': GraphicDecoder, 'palette': PaletteDecoder, 'bin': BinaryDecoder, 'translation': TranlationMap, 'index': IndexDecoder}
		self._validate()
		self.label_lookup = {}
